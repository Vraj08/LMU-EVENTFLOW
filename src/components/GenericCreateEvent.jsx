...
export default function GenericCreateEvent({ backPath = "/", role = "User" }) {
...
useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isValid) {
      toast.error("Please fix the errors in the form.", toastErrorStyle);
      return;
    }
    try {
      ...
      toast.success("Event Successfully Created!", toastSuccessStyle);
      ...
      console.error(err);
      toast.error("Failed to create event", toastErrorStyle);
    }
  };
